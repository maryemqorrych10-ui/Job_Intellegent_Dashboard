...
KAFKA_TOPIC_JOBSPY        = os.getenv("KAFKA_TOPIC_JOBSPY",        "raw_jobs_jobspy")
KAFKA_TOPIC_ADZUNA        = os.getenv("KAFKA_TOPIC_ADZUNA",        "raw_jobs_adzuna")
KAFKA_TOPIC_REMOTIVE      = os.getenv("KAFKA_TOPIC_REMOTIVE",      "raw_jobs_remotive")
KAFKA_TOPIC_REKRUTE       = os.getenv("KAFKA_TOPIC_REKRUTE",       "raw_jobs_rekrute")
KAFKA_TOPIC_STAGIAIRE     = os.getenv("KAFKA_TOPIC_STAGIAIRE",     "raw_jobs_stagiaire")
KAFKA_TOPIC_EMPLOI_MA     = os.getenv("KAFKA_TOPIC_EMPLOI_MA",     "raw_jobs_emploi_ma")
KAFKA_TOPIC_MAROCANNONCES = os.getenv("KAFKA_TOPIC_MAROCANNONCES", "raw_jobs_marocannonces")
